...
class _StockReportState extends State<StockReport> {
  ...
  Future<List<stockreport>> getStockData() async {
    ...
    List<stockreport> widList = value
        .map((element) => stockreport(ItemsName: element['itemsName'], qty:int.parse(element['Qty']),)).toList();
    return widList;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBarNormal(mytitle: "Stock Report"),
      ),
      body: FutureBuilder(
          future: getStockData(),
          builder: (BuildContext context,
            ...
            if (snapshot.hasData) {
              ...
              child: Padding(
                ...
                child: DataTable(dividerThickness: 5,dataRowHeight: 50,columnSpacing: 170,
                  ...
                  rows: reportList!.map((element) => DataRow(
                    cells: [
                      DataCell(Text(element.ItemsName)),
