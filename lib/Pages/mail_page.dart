...
class _MailPageState extends State<MailPage> {
  final controlerTo = TextEditingController(text: "info@amalgamatetechnologies.com");
  final controllerSubject = TextEditingController();
  final controllerMessage = TextEditingController();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Sugestions"),centerTitle: true,),
  ...
  Widget buildTextfield({required String title,required TextEditingController controller,int maxLines=1,})=>
      Column(
