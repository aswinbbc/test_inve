...
//       ),
  ...
  Widget buildCard(var element) {
    return GestureDetector(
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(behavior:SnackBarBehavior.floating,margin: EdgeInsets.all(10),content: Text("User Successfully LoggedIn"),));
      ...
      child: Padding(
        ...
        child: Container(height: 150,width:300,
          ...
          child: Column(
            children: [
              const Image(image: AssetImage("assets/shopImage.png"),height: 80,width: 80,),
              Text(element['clientName'], style: const TextStyle(
