...
class UserLogin{
  ...
  Future<String> login(String? username,String? pass) async{
    ...
    var data = await getData("${Url}login.php",params:{'uname':username,'pass':pass});
...
class SummaryMaster{
  ...
  cashsummary(DateTime today) async{
    ...
    final params = {'currentdate':formatted,'clientId':clientId};
    //print(params);
    var data = await getData("${Url}CashSummaryMaster.php",params:params);
    //print("wekreport = $data");
    return data;
  }
}
...
class ChequeMasterReceived {
  ...
  chequereceived(DateTime today) async {
    ...
    var data = await getData(
        "${Url}ChequeNotificationReceived.php",
        params: params);
    //print("wekreport = $data");
    return data;
  }
...
class ChangePassword{
  ...
  Future<String> editPassword(String? email,String? pass) async{
    ...
    // var data = await getData("http://10.0.2.2:8080/Amber/login.php",params:{'uname':username,'pass':pass});
    var data = await getData("${Url}changepassword.php",params:{'email':email,'pass':pass});
...
class AccountsVoucherSummary{
  ...
  vouchersummary(DateTime today) async{
    ...
    final params = {'currentdate':formatted,'clientId':clientId};
    //print(params);
    var data = await getData("${Url}AccountsVoucherSummary.php",params:params);
    //print("wekreport = $data");
    return data;
  }
}
